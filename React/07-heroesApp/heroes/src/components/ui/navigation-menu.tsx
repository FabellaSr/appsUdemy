...
const navigationMenuTriggerStyle = cva(
  "bg-slate-200 text-slate-900 hover:bg-slate-300 data-[state=open]:bg-slate-300 px-3 py-2 rounded-md inline-flex items-center text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
)
