...
import MyNotificationsPage from '../panel/page/MyNotificationsPage';
import AdminProvidersPage from '../admin/page/AdminProvidersPage';
import AdminPaymentsPage from '../admin/page/AdminPaymentsPage';
import AdminNotificationsPage from '../admin/page/AdminNotificationsPage';
